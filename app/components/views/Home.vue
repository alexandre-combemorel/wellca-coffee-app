  ...
  <GridLayout rows="auto, *" class="home">
    ...
    <ScrollView row="1" @scroll="getScroll" orientation="vertical" class="home__section">
      <StackLayout class="home__wrapper">
        ...
        <StackLayout class="home__opening">
          <StackLayout class="home__opening__calendar">
            <calendar-item/>
            <calendar-item/>
          ...
          <GridLayout columns="auto, *" rows="auto, auto" class="home__opening__content">
            <StackLayout rowSpan="2" col="0" class="home__opening__content__clock"></StackLayout>
            <Title row="0" col="1" :content="`Mercredi`" class="home__opening__content__title"/>
            <StackLayout row="1" col="1" class="home__opening__content__info">
              <StackLayout class="home__opening__content__info__item" orientation="vertical">
                <Label text="7h - 13h" class="home__opening__content__info__item__text"/>
                <Label text="Bourges" class="home__opening__content__info__item__text"/>
                <Label text="Marché de la chancellerie" class="home__opening__content__info__item__text"/>
              </StackLayout>
              <StackLayout class="home__opening__content__info__item" orientation="vertical">
                <Label text="7h - 13h" class="home__opening__content__info__item__text"/>
                <Label text="Bourges" class="home__opening__content__info__item__text"/>
          ...
          <FlexboxLayout class="home__opening__content-description">
            <StackLayout class="home__opening__content-description__item">
              <Label text="Evenement :" class="home__opening__content-description__item__title"/>
              <Label text="Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nulla rhoncus, risus in convallis vehicula, nisl leo mollis orci, id vestibulum sem enim maximus enim. Orci varius natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus. Morbi nibh sapien, ultricies eget turpis ut, interdum molestie purus. " class="home__opening__content-description__item__text"/>
            </StackLayout>
          </FlexboxLayout>
        </StackLayout>
        <SectionTitle :content="`MAP`" class="home__section-title"/>
